...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Home || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="view/parasailing.php">Parasailing</a>
                        </li>
                        <li>
                            <a href="view/banana.php">Banana Boat</a>
                        </li>
                        <li>
                            <a href="view/jetski.php">Jet Ski</a>
                        </li>
                        <li>
                            <a href="view/flyboard.php">Fly Board</a>
                        </li>
                        <li>
                            <a href="view/flyfish.php">Fly Fish</a>
                        </li>
                        <li>
                            <a href="view/donutfly.php">Donut Fly</a>
                        </li>
                        <li>
                            <a href="view/scubadiving.php">Scuba Diving</a>
                        </li>
                        <li>
                            <a href="view/snorkeling.php">Snorkeling</a>
                        </li>
                        <li>
                            <a href="view/seawalker.php">Sea Walker</a>
                        </li>
                        <li>
                            <a href="view/mangrove.php">Mangrove Tour</a>
                        </li>
                        <li>
                            <a href="view/waterskiing.php">Water Skiing</a>
                        </li>
                        <li>
                          <a href="view/glassboat.php">Glass Bottom Boat Tour</a>
                        </li>
                        <li>
                            <a href="view/fishing.php">Fishing</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="view/galeri.php">Galeri</a>
                </li>
                <li>
                    <a href="view/contact.php">About Us</a>
                </li>
            </ul>
        </nav>
        <div id="content">
            ...
            <br><br>
            <p class="text-justify">Tanjung Benoa adalah salah satu lokasi destinasi wisata di Bali yang terkenal sebagai lokasi terbaik untuk aktivitas Wisata Bahari yaitu Water Sports. Pandan Sari Dive & Water Sports adalah salah satu penyedia wahana Water Sporst Sports di Tanjung Benoa. Berlokasi di Jalan Pratama Pempat Agung no. 107 Tanjung Benoa Nusa Dua, Badung – 80361, Bali, Indonesia.</p>
            <p class="text-justify">Pandan Sari Dive & Watersport adalah pengelola watersport yang lengkap, murah dan nyaman. Menurut Managing Director Pandan Sari, Agus Sujata, kepuasan pelanggan adalah tujuan utama. “Kami memperlakukan pelanggan kami sebagai bagian dari keluarga kami dan persahabatan adalah aturan dalam kami menjalankan bisnis,”ujar Agus.</p>
            <br>
                  ...
                  <div class="col-lg-3">
                    <div class="card-basic">
                      ...
                      <div class="card-body">
                        ...
                        <p class="text-center text-light">Rp. 90.000</p>
                        <input type="hidden" name="jumlah16" id="jumlah16" class="" value="90000" />
              ...
              <div class="container text-center text-md-left mt-5">
                <div class="row mt-3 dark-grey-text">
                  ...
                  <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
                    <h5 class="text-white">Pandan Sari</h5>
                    <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto bg-light" style="width: 60px;">
