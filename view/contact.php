...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>ABOUT US || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <h3 id="testimoni" class="text-center text-white">Documentary Our Group</h3>
            <div class="slideshow-container">
              <div class="mySlides fade">
                <img class="rounded center" src="../img/banana.jpg" style="width:100%">
              </div>
              <div class="mySlides fade">
                <img class="rounded center" src="../img/jetski.jpg" style="width:100%">
              </div>
              <div class="mySlides fade">
                <img class="rounded center" src="../img/wakeboard.jpg" style="width:100%">
              </div>
            </div>
            <br>
