...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>DONUT FLY || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Donut Fly</h3>
            <p class="text-justify rata">Donut juga tidak kalah seru dengan permainan lainnya, donut boat adalah sebuah permainan yang berbentuk donut dengan ukuran besar yang akan dinaiki peserta aktivitas dimana benda ini digoyang dan ditarik dengan speed boat. Permainan ini bisa dimainkan oleh 2-5 orang dengan durasi 15 menit atau 1 putaran.</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.donutfly.value;
      two = document.autoSumForm.jumlah16.value;
