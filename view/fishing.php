...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>FISHING || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Fishing</h3>
            <p class="text-justify rata">Fishing merupakan kegiatan menangkap ikan di Tanjung Benoa. Dibagi menjadi 2 macam yaitu Trolling Fishing dan Coral Fishing. Trolling Fishing adalah tehnik memancing dengan menggunakan umpan yang terbuat dari bahan plastik dan timah sebagai pemberat. Sedangkan Coral Fishing adalah tehnik memancing dengan menggunakan umpan hidup seperti ikan dll. Peserta akan diajak ke tengah laut untuk mencari ikan yang sangat besar. Untuk mencapai lokasi ini, biasanya menggunakan boat khusus memancing. Tak hanya 2 itu, Pandan Sari Dive & Wate Sports menyediakan teknik fishing terbaru yaitu Spear Fishing. Spear dalam bahasa inggris berarti ujung tombak dan Fishing berarti kegiatan mencari ikan, secara umum olahraga Spear Fishing adalah mencari atau berburu ikan dengan menggunakan tombak. Jadi, secara garis besar olahraga Spear Fishing ini dilakukan di dalam kedalaman laut dengan senapan tombak yang didesain khusus seperti untuk berburu. Tentu saja berburu ikan di lautan berbeda dengan berburu hewan di pedalaman hutan, perlengkapan olahraga Spear Fishing ini tampak lebih banyak karena dilengkapi dengan perangkat menyelam juga</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.trawling.value;
      two = document.autoSumForm.jumlah10.value;
      tree = document.autoSumForm.coral.value;
      four = document.autoSumForm.jumlah11.value;
      five = document.autoSumForm.spear.value;
      six = document.autoSumForm.jumlah12.value;
      document.autoSumForm.total.value = (one * two) + (tree * four) + (five * six);
    }
    function stopCalc(){
