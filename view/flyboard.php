...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>FLY BOARD || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Fly Board</h3>
            <p class="text-justify rata">Fly Board inilah permainan terbaru yang cukup populer di Tanjung Benoa. Kegiatan terbang di atas papan dengan dorongan air di pantai. Jika anda memilih permainan yang satu ini, anda akan merasa seperti iron man dan membuat penasaran banyak orang. Sebuah roket air, tersambung dengan sebuah alat berbentuk seperti jet ski, yang menyediakan daya dorong untuk fly board menggunakan udara dan air. Pengguna flyboard akan menggunakan sepatu yang telah terhubung dengan selang jet ski. Dimana selang tersebut yang menyalurkan dorongan air sehingga fly board terbang kurang lebih 10 meter. Bagi pengguna flyboar yang telah mahir, biasanya mereka melakukan atraksi yang memukau. Tetapi bagi anda yang pemula, anda akan ditemani dengan instruktur professional untuk menjamin keselamatan anda.</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.flyboard.value;
      two = document.autoSumForm.jumlah9.value;
