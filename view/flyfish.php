...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>FLY FISH || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Flying Fish</h3>
            <p class="text-justify">Fly Fish ini permainan water sport yang menggunakan sebuah perahu karet berbentuk menyerupai ikan. Diatasnya terdapat karet penghubung, serta dibagian pinggir kanan kirinya ada semacam sayap menyerupai sirip ikan. Permainan ini dilakukan maksimal tiga orang. Dua orang peserta fly fish pada sisi kanan dan kiri, serta satu orang pemnadu ditengah-tengah. Perahu karet Flying Fish akan ditarik Speed Boat dari tepi pantai menuju ke tengah-tengah pantai. Speed Boat dikemudikan oleh kapten dengan kecepatan tinggi dan melawan arah angin. Karena melawan angin, perahu Flying Fish akan terbang tinggi. Ketinggian tergantung pada kecepatan angin. Dari kejauhan akan tampak seperti layang-layang terbang di laut. Permainan ini dimainkan sebanyak 2 kali terbang.</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.flyfish.value;
      two = document.autoSumForm.jumlah3.value;
