...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>GALERI || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <h3 id="testimoni" class="text-center text-white">Galeri</h3>
            <div class="container page-top">
                 <div class="row">
                     <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/parasailing.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/parasailing.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                     <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/Donut.jpg"  class="fancybox" rel="ligthbox">
                             <img  src="../img/Donut.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                     <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/flyboard.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/flyboard.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                     <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/glass.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/glass.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                      <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/jetski.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/jetski.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                      <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/turtle.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/turtle.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                      <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/wakeboard.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/wakeboard.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                      <div class="col-lg-3 col-md-4 col-xs-6">
                         <a href="../img/waterskiing.jpg" class="fancybox" rel="ligthbox">
                             <img  src="../img/waterskiing.jpg" class="zoom img-fluid center-img"  alt="">
                         </a>
                     </div>
                     <div class="col-lg-3 col-md-4 col-xs-6">
                        <a href="../img/line_42737290956141.jpg" class="fancybox" rel="ligthbox">
                            <img  src="../img/line_42737290956141.jpg" class="zoom img-fluid center-img"  alt="">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-xs-6">
                       <a href="../img/line_42734206721559.jpg" class="fancybox" rel="ligthbox">
                           <img  src="../img/line_42734206721559.jpg" class="zoom img-fluid center-img"  alt="">
                       </a>
                   </div>
                   <div class="col-lg-3 col-md-4 col-xs-6">
                      <a href="../img/205203.jpg" class="fancybox" rel="ligthbox">
                          <img  src="../img/205203.jpg" class="zoom img-fluid center-img"  alt="">
                      </a>
                  </div>
                </div>
             </div>
