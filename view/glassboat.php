...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>GLASS BOTTOM BOAT || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Glass Bottom Boat Tour</h3>
            <p class="text-justify rata">Glass Bottom Boat Tour merupakan perahu yang dilengkapi dengan kaca bening ditengahnya, untuk menikmati pemandangan di bawah laut yang indah, melihat terumbu karang, tanaman laut dan hewan laut lainnya tanpa harus basah-basahan atau berenang. Wisatawan juga bisa memberi makan ikan di laut dengan roti yang sudah disiapkan. Setelah puas berkeliling, biasanya wisatawan akan balik ke Pandan Sari Water Sports atau jika sudah mengambil paket ke turtle island (pulau penyu) maupun mangrove tour untuk melihat hutan bakau yang indah, wisatawan bisa melanjutkan perjalanan ke destinasi yang sudah dipilih.</p>
              ...
              <div class="row rata">
                ...
                <div class="col-lg-3 col-lg-2">
                  <div class="card-basic">
                    ...
                    <div class="card-body">
                      <h6 class="card-title text-center text-light">
                        Glass Boat + Turtle Island
                      </h6>
                      <p class="text-center text-light">Rp. 130.000</p>
                      <input type="hidden" name="jumlah18" id="jumlah18" class="" value="130000" />
                      <input  class="form-control" type="number" name="turtleisland" value="0" min="2" id="turtleisland" placeholder="Person" onFocus="startCalc();" onBlur="stopCalc();">
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-lg-2">
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.glass.value;
      two = document.autoSumForm.jumlah17.value;
      tree = document.autoSumForm.turtleisland.value;
      four = document.autoSumForm.jumlah18.value;
      document.autoSumForm.total.value = (one * two) + (tree * four);
    }
    function stopCalc(){
