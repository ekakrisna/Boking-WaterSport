...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>SCUBA DIVING || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Scuba Diving</h3>
            <p class="text-justify rata">Scuba Diving merupakan kegiatan menyelam di bawah permukaan air menggunakan alat bantu pernafasan dengan tabung udara. Kata scuba sendiri berasa dari singkatan Self Contained Underwater Breathing Apparatus, alat inilah yang dibawa sendiri oleh para penyelam saat melakukan penyelaman. Dengan tabung udara (oksigen) yang dibawa saat melakukan penyelaman, para penyelam lebih bebas beraktivitas di dalam air. Kegiatan ini bertujuan untuk melihat langsung keindahan biota laut secara dekat di Laut Tanjung Benoa.</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.scubadiving.value;
      two = document.autoSumForm.jumlah4.value;
