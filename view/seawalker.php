...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>SEA WALKER || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.seawalker.value;
      two = document.autoSumForm.jumlah8.value;
