...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>SNORKELING || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Snorkeling</h3>
            <p class="text-justify rata">Snorkeling merupakan aktivitas berenang di permukaan air tanpa menyelam lebih dalam. Alat yang digunakan yakni snorkel, masker, dan kaki katak (fin). Kegiatan snorkeling bisa dilakukan semua orang. Penyelam yang tidak bisa berenang atau tidak bisa mengapung bisa dibantu dengan menggunakan pelampung. Penyelam bisa bernafas didalam air dengan bantuan alat yang bernama snorkel.</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.snorkeling.value;
      two = document.autoSumForm.jumlah5.value;
