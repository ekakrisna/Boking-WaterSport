...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>WATER SKIING || Pandan Sari Dive & Water Sports</title>
    <!-- Bootstrap CSS CDN -->
    ...
    <div class="wrapper">
      <nav id="sidebar">
        ...
        <div id="content">
            ...
            <br><br>
            <!-- <div class="line"></div> -->
            <h3 id="testimoni" class="text-center text-white">Water Skiing</h3>
            <p class="text-justify rata">Water Skiing ini salah satu wahana yang sangat cocok bagi wisatawan muda yang senang tantangan dan berjiwa pertualangan. Mirip dengan permainan ski, hanya saja permainan ini di pantai dan ditarik dengan speed boat. Permainan water skiing menuntut anda untuk berdiri di atas sepatu ski dengan seimbang. Kemudian anda akan memegang tali sepanjang 3 meter, tali tersebutlah yang diikatkan pada bagian belakang speed boat yang akan menarik anda mengelilingi pantai.</p>
  ...
  <script>
    ...
    function calc(){
      one = document.autoSumForm.waterskiing.value;
      two = document.autoSumForm.jumlah7.value;
